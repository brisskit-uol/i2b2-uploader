...
GRANT ALL PRIVILEGES ON SCHEMA <METADATA_SCHEMA_NAME> to <METADATA_USER_NAME> ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA <METADATA_SCHEMA_NAME> TO <METADATA_USER_NAME>;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA <METADATA_SCHEMA_NAME> TO <METADATA_USER_NAME>;
...
/*  DDL for Table the project's initial and main ontology  */
	...
	CREATE TABLE <PROJECT-METADATA-TABLE>
   (	C_HLEVEL INT			NOT NULL, 
	C_FULLNAME VARCHAR(700)	NOT NULL, 
	C_NAME VARCHAR(2000)		NOT NULL, 
	C_SYNONYM_CD CHAR(1)		NOT NULL, 
   ...
   CREATE INDEX META_FULLNAME_IDX_custom ON <PROJECT-METADATA-TABLE>(C_FULLNAME)
;

   CREATE INDEX META_APPLIED_PATH_IDX_custom ON <PROJECT-METADATA-TABLE>(M_APPLIED_PATH)
;
...
INSERT INTO TABLE_ACCESS(C_TABLE_CD, C_TABLE_NAME, C_HLEVEL, C_FULLNAME, C_NAME, C_SYNONYM_CD, C_VISUALATTRIBUTES, C_TOTALNUM, C_BASECODE, C_METADATAXML, C_FACTTABLECOLUMN, C_DIMTABLENAME, C_COLUMNNAME, C_COLUMNDATATYPE, C_OPERATOR, C_DIMCODE, C_COMMENT, C_TOOLTIP, C_ENTRY_DATE, C_CHANGE_DATE, C_STATUS_CD, C_PROTECTED_ACCESS, VALUETYPE_CD)
  VALUES('<PROJECT_ONTOLOGY>', '<PROJECT_ONTOLOGY>', 0, '\<PROJECT_ONTOLOGY>\', '<PROJECT_ONTOLOGY>', 'N', 'CA', NULL, NULL, NULL, 'concept_cd', 'concept_dimension', 'concept_path', 'T', 'LIKE', '\<PROJECT_ONTOLOGY>\', NULL, '<PROJECT_ONTOLOGY>', NULL, NULL, NULL, 'N', NULL);
