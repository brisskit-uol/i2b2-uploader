...
create user <SCHEMA_NAME> password '<SCHEMA_NAME>';
...
CREATE TABLE i2b2metadata.<PROJECT_NAME> (	
   ...
   CREATE INDEX META_FULLNAME_IDX_<PROJECT_NAME> ON <PROJECT_NAME>(C_FULLNAME) ;
   CREATE INDEX META_APPLIED_PATH_IDX_<PROJECT_NAME> ON <PROJECT_NAME>(M_APPLIED_PATH) ;


set schema 'i2b2hive';


-- UPDATE CRC_DB_LOOKUP SET C_DOMAIN_ID = 'LRBRU' WHERE C_DOMAIN_ID = 'BRISSKIT';
-- UPDATE IM_DB_LOOKUP SET C_DOMAIN_ID = 'LRBRU' WHERE C_DOMAIN_ID = 'BRISSKIT';
-- UPDATE ONT_DB_LOOKUP SET C_DOMAIN_ID = 'LRBRU' WHERE C_DOMAIN_ID = 'BRISSKIT';
-- UPDATE WORK_DB_LOOKUP SET C_DOMAIN_ID = 'LRBRU' WHERE C_DOMAIN_ID = 'BRISSKIT';
...
VALUES ('BRISSKIT', '<SCHEMA_NAME>/', '@', 'i2b2metadata', 'java:/<OProject1DS>', 'POSTGRESQL', 'Metadata', null, null, now(), now(), null);
...
VALUES ('BRISSKIT', '<SCHEMA_NAME>/', '@', 'i2b2workdata', 'java:/<WProject1DS>', 'POSTGRESQL', 'Workplace', null, null, now(), now(), null);
...
VALUES ('BRISSKIT', '<SCHEMA_NAME>/', '@', 'i2b2im', 'java:/<IMProject1DS>', 'POSTGRESQL', 'IM', null, null, now(), now(), null);
