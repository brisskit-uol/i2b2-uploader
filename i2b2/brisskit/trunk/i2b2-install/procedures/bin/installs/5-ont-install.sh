...
#
# USAGE: 5-ont-install.sh job-name
# Where: 
...
print_project_install_usage() {
   echo " USAGE: 5-ont-install.sh job-name"
   echo " Where:"
...
#===========================================================================
print_banner "5-ont-install.sh" $JOB_NAME $LOG_FILE 
...
merge_config $I2B2_INSTALL_HOME/config/config.properties \
             $I2B2_INSTALL_HOME/config/$DB_TYPE/ont-cell/OntologyApplicationContext.xml \
...
merge_config $I2B2_INSTALL_HOME/config/config.properties \
             $I2B2_INSTALL_HOME/config/$DB_TYPE/ont-cell/build.properties \
...
merge_config $I2B2_INSTALL_HOME/config/config.properties \
             $I2B2_INSTALL_HOME/config/$DB_TYPE/ont-cell/ont-ds.xml \
...
merge_config $I2B2_INSTALL_HOME/config/config.properties \
             $I2B2_INSTALL_HOME/config/$DB_TYPE/ont-cell/ontology_application_directory.properties \
...
merge_config $I2B2_INSTALL_HOME/config/config.properties \
             $I2B2_INSTALL_HOME/config/$DB_TYPE/ont-cell/ontology.properties \
