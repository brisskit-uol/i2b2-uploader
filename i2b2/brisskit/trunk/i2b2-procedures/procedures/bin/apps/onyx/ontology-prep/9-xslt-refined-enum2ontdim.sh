...
#
# USAGE: 9-xslt-refined-enum2ontdim job-name 
# Where: 
...
print_xslt_refined_enum2ontdim_usage() {
   echo " USAGE: 9-xslt-refined-enum2ontdim.sh job-name"
   echo " Where:"
...
INPUT_DIR=$I2B2_PROCEDURES_WORKSPACE/$JOB_NAME/$REFINED_METADATA_ENUMS_DIRECTORY
#
# And it must exist!
if [ ! -d $INPUT_DIR ]
then
...
#===========================================================================
print_banner "xslt-refined-enum2ontdim" $JOB_NAME $LOG_FILE

#
# And the output directory is...
OUTPUT_DIR=$I2B2_PROCEDURES_WORKSPACE/$JOB_NAME/$METADATA_SQL_DIRECTORY/$DB_TYPE/ontdim
#
# And it must exist!
if [ ! -d $OUTPUT_DIR ]
then
...
STYLESHEET=$I2B2_PROCEDURES_HOME/xslt/$DB_TYPE/ont_dim_enumerations_${DB_TYPE}.xsl
...
print_footer "xslt-refined-enum2ontdim" $JOB_NAME $LOG_FILE