...
insert into QT_BREAKDOWN_PATH(name,value,create_date) values ('PATIENT_GENDER_COUNT_XML','\\ONYX\onyx\Participant\gender\',getdate())
insert into QT_BREAKDOWN_PATH(name,value,create_date) values ('PATIENT_RACE_COUNT_XML','\\ONYX\onyx\Participant\pat_ethnicity\',getdate())
insert into QT_BREAKDOWN_PATH(name,value,create_date) values ('PATIENT_VITALSTATUS_COUNT_XML','\\ONYX\onyx\Participant\vital_status\',getdate())
insert into QT_BREAKDOWN_PATH(name,value,create_date) values('PATIENT_AGE_COUNT_XML','\\ONYX\onyx\Participant\age\',getdate())
