...
# edit /local/i2b2-procedures-1.0-development/bin/apps/catissue/database/ant/scripts/create_catissue.sql
# make sure the 3 databases are in it. 
# cp config.properties /local/i2b2-procedures-1.0-development/config
# cp defaults.sh /local/i2b2-procedures-1.0-development/config

cd $I2B2_PROCEDURES_HOME/bin/project-install 
./1-project-install-onyx-only.sh ${workspace}
