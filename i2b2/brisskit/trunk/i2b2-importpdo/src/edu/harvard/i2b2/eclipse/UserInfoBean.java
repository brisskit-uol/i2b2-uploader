...
public class UserInfoBean {
	...
	/**
	 * Added by Jeff Lusted for Briccs and BrissKit projects.
	 * <br/><br/>
	 * We have a problem with the cell addresses returned when ImportPdo is acting
	 * behind a firewall that is itself doing SSL encryption/decryption for us.
	 * This gives us access to alter the returned addresses when the programme
	 * is executing co-located with the hive cells
	 * 
	 * @return CellDatasType
	 */
